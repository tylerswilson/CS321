...
<!-- // Program to draw a 3d pyramid, and a Dimpled Cube with a fly over
...
function render()
{
    ...
    pyrm = mult(viewer, mult( mult(translate(0.5, 0.0, -1.5),rotate(160, 20, 15, 0.0)),scaleObject));
    gl.uniformMatrix4fv(modelViewLoc, false, flatten(pyrm));
    gl.drawArrays(gl.TRIANGLES,0,numPyramidVertices);

    cube = mult(viewer, mult( mult(translate(-1.8, -0.3, -0.5),rotate(20, 0.0, 1.0, 0.0)),scaleObject));
